    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-md-offset-4 text-center">
				...
				<div class="form-box">
                    <div class="caption">
                        <h4>Register As Psychologist</h4>
                    </div>
                    <?php echo form_open(base_url('auth/psychologist_register'), 'class="register-form" '); ?>
                        <div class="input-group">
							...
							<input type="text" name="degree" id="degree" class="form-control validate[required]" placeholder="Degree" >
							...
							<select name="specialities" id="Specialities" class="form-control validate[required]">
