    ...
    <div class="box-body table-responsive">
		<div class="send_message_outer">
			<div class="all_threads_box">
				...
				<div class="thread_box <?php if($therapist_id == $therapist->therapist_id) { ?>active_thread<?php } ?>">
					<a href="<?php echo base_url('my_therapist/send_message').'/'.base64_encode($patient_id).'/'.base64_encode($therapist->therapist_id); ?>">
						<div class="thread_title"><?php echo $therapist->uname.' '.$therapist->surname; ?></div>
			...
			<div class="prof_conf_msgs_box">
				...
				<div class="conf_msg_box" style="width: 100%; padding-left: 20px;margin-bottom:10px;padding-right: 20px;">
					<?php echo form_open(base_url('my_therapist/send_message').'/'.base64_encode($patient_id).'/'.base64_encode($therapist_id), 'enctype="multipart/form-data" '); ?>
						<input type="hidden" name="patient_id" value="<?php echo $patient_id; ?>">
						<input type="hidden" name="therapist_id" value="<?php echo $therapist_id; ?>">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td valign="top" style="padding-top: 5px;">Therapist:&nbsp;<strong><?php echo $user_info->uname.' '.$user_info->surname; ?></strong></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
...
jQuery(document).ready(function(){
	...
	setInterval(function(){ 
		jQuery.ajax({
		  method: "POST",
		  url: "<?php echo base_url('my_therapist/get_patient_message'); ?>",
